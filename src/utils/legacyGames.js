// Legacy Game Modules extracted from old architecture
const GAME_MODULES = {};

GAME_MODULES.rps = function(container, api){
...
GAME_MODULES.wordscramble = function(container, api){
  const div = document.createElement('div'); div.style="text-align:center; color:white;";
...
GAME_MODULES.simon = function(container, api){
...
GAME_MODULES.clicker = function(container, api){
  const div = document.createElement('div'); div.style="text-align:center; color:white;";
...
GAME_MODULES.mathquiz = function(container, api){
...
GAME_MODULES.colormatch = function(container, api){
...
GAME_MODULES.reaction = function(container, api){
...
GAME_MODULES.minesweeper = function(container, api){
...
GAME_MODULES.breakout = function(container, api){
...
GAME_MODULES.flappy = function(container, api){
  const canvas = document.createElement('canvas');
